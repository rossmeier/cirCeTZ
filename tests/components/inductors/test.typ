...
#canvas({
  ...
  for r in (
    inductor,
    inductor.with(coils: 4),
    vinductor,
    sinductor,
    inductor.with(style: (inductor: "american")),
    inductor.with(coils: 5, style: (inductor: "american")),
    vinductor.with(coils: 4, style: (inductor: "american")),
    sinductor.with(style: (inductor: "american")),
    inductor.with(style: (inductor: "european")),
    vinductor.with(style: (inductor: "european")),
    sinductor.with(style: (inductor: "european")),
  ) {
    ...
    r((rel: (xDistance, 0), to: "a"), (rel: (line-length,0)), name: "a")
    show-anchor("a.core-west", offset: "south-east", pos: (135deg, 0.1))
    show-anchor("a.core-east", offset: "south-west", pos: (45deg, 0.1))
    show-anchor("a.ll-dot", offset: "east", pos: (180deg, 0.1))
    show-anchor("a.ul-dot", offset: "east", pos: (180deg, 0.1))
    show-anchor("a.lr-dot", offset: "west", pos: (0deg, 0.1))
    show-anchor("a.ur-dot", offset: "west", pos: (0deg, 0.1))
